		...
		<div class="container">
			 <form  name="newMember" action="processUpdateMember.jsp" method="post" onsubmit="return checkForm()">
				...
				<label class="col-sm-2">아이디</label>
					<div class="col-sm-5">
						<input type="text" name="id" class="form-control" placeholder="아이디를 입력하세요" value="<c:out value='${row.id}'/>" >
					</div>
			</div>
			...
			<div class="mb-3 row">
				<label class="col-sm-2">비밀번호</label>
					<div class="col-sm-5">
						<input type="text" name="password" class="form-control" placeholder="비밀번호를 입력하세요" value="<c:out value='${row.password}'/>" >
					</div>
			</div>
			...
			<div class="mb-3 row">
				<label class="col-sm-2">성명</label>
					<div class="col-sm-5">
						<input type="text" name="name" class="form-control" placeholder="성함을 입력하세요" value="<c:out value='${row.name}'/>" >
					</div>
			</div>
			...
			<div class="mb-3 row">
				<label class="col-sm-2">생년월일</label>
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-2">
								<input type="text" name="birthyy" maxlength="4" class="form-control" placeholder="년(1997)" size="6" value="${year}" >
							</div>
							<div class="col-sm-2">
								<input type="text" name="birthmm" maxlength="2" class="form-control" placeholder="월(07)" size="4" value="${month}" >
							</div>
							<div class="col-sm-2">
								<input type="text" name="birthdd" maxlength="2" class="form-control" placeholder="일(02)" size="4" value="${day}" >
							</div>
						</div>
					</div>
			</div>
			...
			<div class="mb-3 row">
				<label class="col-sm-2">전화번호</label>
					<div class="col-sm-5">
						<input type="text" name="phone" class="form-control" placeholder="전화번호를 입력하세요" value="<c:out value='${row.phone}'/>">
					</div>
			</div>
			...
			<div class="mb-3 row">
				<label class="col-sm-2">주소</label>
					<div class="col-sm-5">
						<input type="text" name="address" class="form-control" placeholder="주소를 입력하세요" value="<c:out value='${row.address}'/>">
					</div>
			</div>
